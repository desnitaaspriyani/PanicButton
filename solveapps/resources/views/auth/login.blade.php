...
<head>
    ...
    <!-- Bootstrap CSS
        ============================================ -->
    <link rel="stylesheet" href="css/end/font-awesome.min.css">
    <!-- owl.carousel CSS
        ============================================ -->
                    ...
                    <div class="panel-body">
                        <form method="POST" action="{{ route('login') }}"id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <input  id="email" type="email" title="Please enter you username" required="" name="email" value="{{ old('email') }}"class="form-control">
